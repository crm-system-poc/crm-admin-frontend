...
export default function QuotationList() {
  ...
  const [quotationToAssign, setQuotationToAssign] = useState<Lead | null>(null);
  ...
  const handleCreatePO = (q: any) => {
    // console.log("-----", q.leadId, q.id, q.leadId.id)
    if (q.id && q.leadId) {
    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
                ...
                <TableRow key={q.id} className="hover:bg-muted/30">
                  ...
                  <TableCell>
                    <Badge
                      className={`capitalize ${
                        statusColorMap[q.status] || "bg-gray-100 text-gray-700"
                      }`}
                    >
                      {q.status}
                    </Badge>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu
                      ...
                      onOpenChange={(open) =>
                        setOpenDropdownId(open ? q.id : null)
                      }
                    >
      ...
      {quotationToAssign && (
        <AssignQuotationDialog
          ...
          quotationId={quotationToAssign.id}
          currentAssigneeName={
