...
export default function EditProductPage() {
  ...
  // Add created/updated by and date/time into the state for bottom-of-page display
  ...
  const [meta, setMeta] = useState({
    createdAt: "",
    updatedAt: "",
    createdBy: { name: "", email: "", id: "" },
    updatedBy: { name: "", email: "", id: "" },
    id: "",
  });
    ...
    fetch(`http://localhost:8080/api/products/${id}`, {
      ...
      .then(async (res) => {
        ...
        setForm({
          ...
          oemPrice: data?.oemPrice !== undefined ? String(data.oemPrice) : "",
          sellingPrice: data?.sellingPrice !== undefined ? String(data.sellingPrice) : "",
        });
        setMeta({
          createdAt: data?.createdAt || "",
          updatedAt: data?.updatedAt || "",
          createdBy: data?.createdBy || { name: "", email: "", id: "" },
          updatedBy: data?.updatedBy || { name: "", email: "", id: "" },
          id: data?.id || "",
        });
      })
      .catch(() => {
