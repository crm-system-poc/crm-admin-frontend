...
export function AssignQuotationDialog({
  open,
  onOpenChange,
  quotationId,
  onAssigned,
  ...
  const handleSave = async () => {
    try {
      ...
      await api.put(`/api/quotations/${quotationId}/reassign`, {
        assignedUsers,
      });

      toast.success("Quotation assignment updated");
      onAssigned?.();
      onOpenChange(false);
    } catch (err: any) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Assign Quotation</DialogTitle>
